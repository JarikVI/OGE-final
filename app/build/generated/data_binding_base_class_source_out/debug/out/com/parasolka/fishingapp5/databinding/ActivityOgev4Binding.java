...
public final class ActivityOgev4Binding implements ViewBinding {
  @NonNull
  ...
  private ActivityOgev4Binding(@NonNull ConstraintLayout rootView, @NonNull TextView answerTextView,
  ...
  @NonNull
  public static ActivityOgev4Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityOgev4Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_ogev4, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityOgev4Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOgev4Binding((ConstraintLayout) rootView, answerTextView, button2,
