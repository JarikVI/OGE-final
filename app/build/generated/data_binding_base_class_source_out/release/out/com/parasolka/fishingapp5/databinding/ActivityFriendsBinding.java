...
public final class ActivityFriendsBinding implements ViewBinding {
  ...
  private ActivityFriendsBinding(@NonNull RelativeLayout rootView,
      @NonNull RecyclerView friendsrecycler) {
    this.rootView = rootView;
    this.friendsrecycler = friendsrecycler;
  }
  ...
  public static ActivityFriendsBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.friendsrecycler;
      RecyclerView friendsrecycler = ViewBindings.findChildViewById(rootView, id);
      if (friendsrecycler == null) {
        break missingId;
      }

      return new ActivityFriendsBinding((RelativeLayout) rootView, friendsrecycler);
    }
